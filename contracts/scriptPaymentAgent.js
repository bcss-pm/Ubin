...
// alias solc0419=/mnt/bin/solc0419/solc
// > solc0419 -o outdir --overwrite --bin --abi PaymentAgent.sol
// var bytecode = "0x... or data: '0x' + bytecode, gas: '200000000'
// gas: '4700000' - The contract code couldn't be stored, please check your gas amount.
// From geth console, loadScript("testcontracts0419/PaymentAgent.abi"), loadScript("testcontracts0419/PaymentAgent.bin")
var abi = ...;

var myContract = web3.eth.contract(abi);
// Node 5
var instance = myContract.new({from:web3.eth.accounts[0], data: bytecode, gas: '200000000', privateFor: ["9lAixDFZgXorIxNVjHcxSD76xih7IGZn6n1B7e8sbTg="]},
function(e, contract) {
	if (e) {
...
//> Contract mined! Address: 0xf2f04d4a455c95f13041a194a15a6b9260c6d813

/* Node 5 */
instance.createStash("bank5", {from:web3.eth.accounts[0], gas: 0x47b760, privateFor: ["9lAixDFZgXorIxNVjHcxSD76xih7IGZn6n1B7e8sbTg="]});

> eth.pendingTransactions;

instance.markStash("bank5", {from:web3.eth.accounts[0], gas: 0x47b760, privateFor: ["9lAixDFZgXorIxNVjHcxSD76xih7IGZn6n1B7e8sbTg="]});

> eth.pendingTransactions;

instance.pledge("tx001", "bank5", 42, {from:web3.eth.accounts[0], gas: 0x47b760, privateFor: ["9lAixDFZgXorIxNVjHcxSD76xih7IGZn6n1B7e8sbTg="]});

> eth.pendingTransactions;
> instance.getBalance("bank5");
42

/* from node 5
var abi = [...;
var address = "0xf2f04d4a455c95f13041a194a15a6b9260c6d813";
